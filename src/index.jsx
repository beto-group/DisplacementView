    ...
    function SafeRoot() {
        ...
        dc.useEffect(function () {
            ...
            if (!styleEl) {
                ...
                styleEl.id = STYLE_ID;
                styleEl.innerHTML = `
                    /* DISPLACEMENT VIEW: Hide global status bar and view footers for immersive full-tab layout */
